...
export const books: Book[] = [
  {
    ...
    why: "Built on decades of watching real couples in a lab, it turns what actually predicts lasting relationships into plain exercises. You can read one chapter and have something to do that same night.",
  },
  {
    title: "Hold Me Tight",
    author: "Sue Johnson",
  ...
  },
  {
    ...
    forWhom:
      "Anyone whose words come out sharper than they mean, and anyone close to them.",
  ...
  },
  {
    ...
    why: "From the researchers behind the PREP program, this is closer to a training manual than a therapy book: concrete rules for fighting fair, taking breaks, and protecting the good parts of the relationship from the arguments.",
  },
  {
    ...
    why: "The Gottmans studied couples through the arrival of a first child and found many relationships take a real hit. This is the practical plan for staying friends, splitting the load, and finding your way back to each other.",
  },
  {
    title: "It's OK That You're Not OK",
    author: "Megan Devine",
    forWhom:
      "A relationship carrying a loss: a death in the family, a pregnancy that ended, a future that isn't coming. Also for the partner who doesn't know what to say.",
    why: "Devine writes about grief without trying to fix it, which is exactly what a grieving partner needs from you. It teaches the supporting partner how to stop cheering up and start showing up.",
  },
  {
  ...
  },
  {
    ...
    forWhom:
      "When one partner's past (a hard childhood, violence, combat, abuse) keeps walking into the relationship uninvited.",
...
export const freeResources: FreeResource[] = [
  ...
  },
  {
    ...
    what: "The public directory of the American Association for Marriage and Family Therapy. Search by location to find a licensed relationship therapist near you.",
    url: "https://www.therapistlocator.net",
  },
  {
    name: "988 Suicide and Crisis Lifeline",
    what: "Free, confidential support around the clock in the United States. Call or text 988, or chat on the website. For any moment that feels bigger than a relationship problem, for you or for your partner.",
    url: "https://988lifeline.org",
  },
  {
    name: "National Domestic Violence Hotline",
    what: "If anything in your relationship frightens you, this is the place to start, not a communication exercise. Call 1-800-799-7233, text START to 88788, or chat on the site. Free, confidential, always open.",
...
export const podcasts: Podcast[] = [
  ...
  },
  {
    ...
    why: "Two working relationship therapists talk plainly about the stuff partners actually fight over: money, sex, in-laws, chores. It feels like overhearing good advice rather than being lectured.",
  },
  {
