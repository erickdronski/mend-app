...
export const whyGateMatters =
  "Guided couple conversations assume both partners are safe to be honest with each other. In relationships with violence, threats, or coercive control, that assumption fails: 'communication exercises' can give an abusive partner material and make things more dangerous. This isn't about your marriage being 'bad enough'; it's about the right tool. If any of this rings true, please start with the hotline. It's free, confidential, and staffed by people who will help you think it through.";
